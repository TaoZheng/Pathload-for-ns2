...
set Par4 [new Application/Traffic/Pareto]
$Par4 set burst_time_ 5ms
$Par4 set idle_time_ 400ms
$Par4 set packetSize_ 1500
$Par4 set rate_ 20Mb
$Par4 set shape_ 1.1   
$Par4 attach-agent $udp4
...
$ns at 12.0 "$Pathload_snd stop"
$ns at 12.0 "$Pathload_rcv stop"

$ns at 0.0 "$Par4 start"
$ns at 12.0 "$Par4 stop"
$ns at 12.1 "finish"
